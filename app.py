...
st.markdown("Real-time fleet optimization and intelligent coordination.")
st.divider()
...
st.divider()
st.subheader("🧪 Experiment Tracker & Comparison")
st.write("Save your current simulation results to compare strategies under different conditions.")
...
if st.session_state.experiment_history:
    ...
    with dl_col:
        ...
        st.download_button(
            ...
            data=csv_data,
            file_name='smart_fleet_comparison.csv',
            mime='text/csv',
            width="stretch"
        )
    with clear_col:
