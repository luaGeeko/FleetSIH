...
class FleetSimulator:
    def __init__(self):
        ...
        # standard OR-Tools solver for benchmarking
        self.ortools_optimizer = ORToolsOptimizer()
        # RL based optimizer will be added later
        self.ai_optimizer = AIPolicyOptimizer()
    ...
    def generate_deterministic_scenario(self):
        ...
        # FIX 2: Removed the hard-coded V01 mock assignment. 
        # The GreedyBaselineOptimizer will now automatically detect these 
        # pending shipments on Tick 1 and assign them dynamically!
    ...
    def step(self):
        ...
        if self.current_strategy == "OR-Tools CVRP":
            ...
            self.ai_optimizer.optimize(self.vehicles, self.shipments, self.state.time_step)
        else:
        ...
        for vid, vehicle in self.vehicles.items():
            ...
            vehicle.time_active += 1 # Track utilization
    ...
    def get_metrics(self):
        ...
        # Calculate Time-based Utilization (Active Time / Total Time)
